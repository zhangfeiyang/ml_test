...
for i in range(0,entries-100):
    ...
    train_data.append([em0/m0,em1/m1,em2/m2,em3/m3,em4/m4,em5/m5,em6/m6,em7/m7])
...
#    b = t.GetLeaf('b').GetValue(0)
    ...
    test_data.append([em0/m0,em1/m1,em2/m2,em3/m3,em4/m4,em5/m5,em6/m6,em7/m7])
...
import pandas as pd
column_names = ['e0','e1','e2','e3','e4','e5','e6','e7']
...
print("predict_y and trule is ")
#print(predict_y,test_labels)
h = TH1F('h','',100,0,0)
for i in range(0,100):
    #h.Fill(predict_y[0][i]/test_labels[0][i]-1)
    h.Fill(predict_y[i]/test_labels[i]-1)

print('the mean and rms is ',h.GetMean(),h.GetRMS())
#print("true is ")
#print(test_labels)
